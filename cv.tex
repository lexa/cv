...
\cvitem{\ml{Other}{Прочее}}{GDB, \LaTeX, Valgrind, Emacs, Doxygen, Yocto, low-level Android, VirtIO}

\section{\ml{Experience}{Опыт работы}}
\cventry{2017--\ml{present}{Настощий момент}}{Software Engineer}{\OpSy}{\BER}{} {
  Development of Virtualization solution for Automotive applications.\newline
  \begin{itemize}
  \item Development of Yocto based Linux distribution for Automotive application.
  \item Porting Linux and Android kernels to a new HW platforms.
  \item Development of Virtio-based kernel drivers.
  \end{itemize}
  }
