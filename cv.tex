...
\item \ml{Development in Linux environment i.e. experience with GCC, GDB, GNU Make, Bash, cross compilation}{Опыт в разработке в Linux окружении с использованием GDB, GCC, Make, Bash в том числе и для кросс-компиляции}
...
\item \ml{Maintaining and configuring network equipment, IP routers, Ethernet switches, Linux/FreeBSD servers}{Поддежка и настройка сетевого оборудования, IP роутеров, Ethernet коммутаторов, Linux/FreeBSD серверов}
\item \ml{Driver development for Linux kernel}{Написание модулей ядра Linux}
\item \ml{Experience with version controll systems Git, Perforce }{Умею пользоваться системами контроля версий Git, Perforce}
\item \ml{Development in big distributed team, use of code review systems like Gerrit and Helix SWARM}{Имею опыт разработки в коллективе, использования код-ревью}
\end{itemize}
...
\cvitem{\ml{Other}{Прочее}}{GDB, \LaTeX, Valgrind, Emacs, Doxygen}
