...
\cventry{2017--\ml{present}{Настощий момент}}{Software Engineer}{\OpSy}{\BER}{} {
  ...
  \begin{itemize}
  \item Ported Linux and Android to a new hardware platforms.
  \item Developed a VirtIO-based kernel device.
  \item Established Continious Integration cycle.
  \item Developed a test system for the project, based of pytest3/python.
  \item Acting as Release Manager.
  \item Fully automated the deployment process.
  \item Reduced release cycle time from month to weeks.
  \end{itemize}
  (Python, Pytest, Lauterbach Trace32, VirtIO, Linux kernel, ARM)
}
